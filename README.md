...
- 🎚️ **Dışa aktarma ayarları**: Format (**MP4** / WebM), çözünürlük (480p / 720p / 1080p / 2K β / 4K β) ve kare hızı (5 / 10 / 15 / 20 / 24 / 30 / 60 / 90 β / 120 β fps) seçimi, tahmini dosya boyutuyla; seçimler projeyle birlikte kaydedilir. MP4 varsayılandır (en uyumlu): H.264 + AAC ile paketlenir, cihaz desteklemezse otomatik WebM'e düşer. β işaretli seçenekler beta'dır — bazı telefonlarda stabil çalışmayabilir
