...
- 📚 **Müzik kütüphaneleri**: Cihazından eklemenin yanında 6 çevrimiçi kaynakta ara, dinle ve tek dokunuşla projeye ekle — 🎧 Phonk sekmesi hazır kategorilerle (Popüler, Drift, Brazilian, Agresif, Chill, Sigma) sekme açılır açılmaz popüler phonk parçalarını listeler; — İnternet Arşivi (archive.org), Openverse ve Wikimedia Commons tam şarkı verir; iTunes 30 sn önizleme verir (döngüleme ile uzatılabilir); eklenen parçalar projeyle birlikte cihazına kaydedilir
- ▶️ **YouTube müzik indirici**: Müzik panelindeki **▶️ YouTube** sekmesinde ara ya da bir YouTube linki (watch / youtu.be / shorts) yapıştır — sesi indirilip projeye müzik olarak eklenir. Sunucusuz çalıştığı için herkese açık açık kaynak Piped/Invidious örnekleri üzerinden gider; bu örnekler ara sıra yavaş/erişilemez olabilir (biri düşerse otomatik diğerine geçilir). Yalnızca telifsiz veya indirme izni olan içerik için kullan
