...
- 📚 **Müzik kütüphaneleri**: Cihazından eklemenin yanında 4 çevrimiçi kaynakta ara, dinle ve tek dokunuşla projeye ekle — İnternet Arşivi (archive.org), Openverse ve Wikimedia Commons tam şarkı verir; iTunes 30 sn önizleme verir (döngüleme ile uzatılabilir); eklenen parçalar projeyle birlikte cihazına kaydedilir
